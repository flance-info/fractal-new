...
<div class="w-full">
	...
	mq925:top-[300px] mq925:translate-x-0 mq925:left-0 mq925:object-cover mq925:max-h-[500px]"
				...
				<div class="slide w-full slide-1 mq925:mt-[-160px] mq600:mt-[-135px] w-calc-100vw-minus-50px">
					...
					<<?php echo esc_html( $slide['heading_tag'] ); ?> class="slider-title slide-heading elementor-heading-title relative font-medium text-77xl mq925:text-59xl tracking-[-4px] leading-[96px] inline-block max-w-[820px]"
	...
	<div class="absolute top-[calc(50%_-_148px)]
		...
		<a href="<?php echo esc_url( $settings['facebook_url']['url'] ); ?>" target="_blank" rel="noopener noreferrer" class="social-link rounded-11xl border-gray-200 border-[1px] border-solid overflow-hidden flex flex-col items-center justify-center p-3">
		...
		<a href="<?php echo esc_url( $settings['youtube_url']['url'] ); ?>" target="_blank" rel="noopener noreferrer" class="social-link rounded-11xl border-gray-200 border-[1px] border-solid overflow-hidden flex flex-col items-center justify-center p-3">
		...
		<a href="<?php echo esc_url( $settings['instagram_url']['url'] ); ?>" target="_blank" rel="noopener noreferrer" class="social-link rounded-11xl border-gray-200 border-[1px] border-solid overflow-hidden flex flex-col items-center justify-center p-3">
		...
		<a href="<?php echo esc_url( $settings['twitter_url']['url'] ); ?>" target="_blank" rel="noopener noreferrer" class="social-link rounded-11xl border-gray-200 border-[1px] border-solid overflow-hidden flex flex-col items-center justify-center p-3">
			<img class="w-6 relative h-6" alt="Twitter" src="/wp-content/themes/fractal/fractal/build/iconssmall-iconssocialtwitter.webp">
		</a>
		<a href="<?php echo esc_url( $settings['linkedin_url']['url'] ); ?>" target="_blank" rel="noopener noreferrer" class="social-link rounded-11xl border-gray-200 border-[1px] border-solid overflow-hidden flex flex-col items-center justify-center p-3">
